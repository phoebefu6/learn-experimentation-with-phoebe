...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    if (m) {
      ...
      var pages = mx
        ? ["a1-why-experiments.html", "a2-reading-a-test.html",
           "a3-trust-checklist.html", "a4-beyond-the-button.html",
           "a5-when-you-cant-randomize.html", "a6-experimentation-culture.html"]
        : ["b1-potential-outcomes.html", "b2-power-and-sample-size.html", "b3-randomization-and-trust.html",
           "b4-run-an-ab-test.html", "b5-multivariate-testing.html", "b6-sequential-and-peeking.html",
           "b7-cuped-variance-reduction.html", "b8-geo-and-synthetic-control.html",
           "b9-difference-in-differences.html", "b10-observational-causal-inference.html"];
